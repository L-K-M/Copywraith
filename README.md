...
- [Ubuntu/GNOME app](README.ubuntu.md): the same desktop app on the Ubuntu default session, with GNOME-registered global shortcuts, a system tray, and ydotool paste.
